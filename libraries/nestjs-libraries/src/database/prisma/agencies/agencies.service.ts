...
<head>
    ...
    <title>Your Agency has been approved and added to VaiMix 🚀</title>
</head>

<body style="font-family: Arial, sans-serif; margin: 0; padding: 0;">
  Hi there, <br /><br />
  Your agency ${agency?.name} has been added to VaiMix!<br />
  You can <a href="https://vaimix.com/agencies/${agency?.slug}">check it here</a><br />
  It will appear on the main agency of VaiMix in the next 24 hours.<br /><br />
</body>
</html>`
      );
    ...
    <table align="center" cellpadding="0" cellspacing="0" style="max-width: 600px; width: 100%; background-color: #ffffff; margin-top: 20px; border: 1px solid #ddd;">
        ...
        <tr>
            <td style="padding: 20px; text-align: center; background-color: #000;">
                <a href="https://vaimix.com/agencies/action/approve/${
                  agency.id
                }" style="margin: 0 10px; text-decoration: none; color: #007bff;">To approve click here</a><br /><br /><br />
                <a href="https://vaimix.com/agencies/action/decline/${
                  agency.id
        ...
        <tr>
            <td style="padding: 20px; text-align: center; background-color: #f4f4f4;">
                <p style="color: #777; font-size: 14px;">&copy; 2024 VaiMix. All rights reserved.</p>
            </td>
        </tr>
    </table>
</body>
